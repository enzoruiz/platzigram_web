...
export default function userPageTemplate(user){
    const el = yo`<div class="containter user-page">
        <div class="row">
            <div class="col s12 m10 offset-m1 l8 offset-l2 center-align heading">
                <div class="row">
                    ...
                    <div class="col s12 m10 offset-m1 l3 left-align">
            ...
            <div class="row">
                ${user.pictures.map(function (picture){
                    return yo`<div class="col s12 m6 l4">
                        <a href="/${user.username}/${picture.id}" class="picture-container modal-trigger">
