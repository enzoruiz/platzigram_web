    ...
    function render(pic_render){
        return yo`<div class="card ${pic_render.liked ? 'liked' : ''}">
            ...
            <div class="card-content">
              <a href="/user/${pic_render.user.username}" class="card-title">
                <img src="${pic_render.user.avatar}" class="avatar"/>
                <span class="username">${pic_render.user.username}</span>
              </a>
              <small class="right time">${moment(pic_render.createdAt).fromNow()}</small>
              <p>
                <a class="left" href="#" onclick=${like.bind(null, true)}><i class="fa fa-heart-o" aria-hidden="true"></i></a>
                <a class="left" href="#" onclick=${like.bind(null, false)}><i class="fa fa-heart" aria-hidden="true"></i></a>
                <span class="left likes">${pic_render.likes}</span>
              </p>
            </div>
          </div>`
    }
